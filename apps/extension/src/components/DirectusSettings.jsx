...
const DirectusSettings = () => {
  ...
  const handleAuthenticate = async () => {
    ...
    try {
      ...
      const authData = await authenticateDirectus({ email, password });
      ...
      } else if (err.message && err.message.includes('Failed to fetch') || err.message && err.message.includes('NetworkError')) {
